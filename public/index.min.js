...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socket.io-client */ \"./node_modules/socket.io-client/lib/index.js\");\n/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socket_io_client__WEBPACK_IMPORTED_MODULE_0__);\ndocument.addEventListener(\"DOMContentLoaded\",function(event){var socket=socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(\"http://localhost:3000\");socket.emit('authorize',{token:localStorage.getItem('token')});var myName=void 0;socket.on('authorize',function(_ref){var name=_ref.name,email=_ref.email;myName=name;});document.querySelector('.j-send-btn').addEventListener('click',function(){var textInput=document.querySelector('.j-msg');var msg=textInput.value;textInput.value=\"\";console.log(myName);socket.emit('chat',{message:msg,token:localStorage.getItem('token'),chatId:'5ad77207b204db43437c9268'});});socket.on('chat',function(_ref2){var name=_ref2.name,message=_ref2.message;var result=document.querySelector('.j-result');var pp=document.createElement('p');pp.innerHTML=name+\" - \"+message;result.appendChild(pp);});socket.on('disconnect',function(){socket.connect();});});\n\n//# sourceURL=webpack:///./src/js/Index/index.js?");
